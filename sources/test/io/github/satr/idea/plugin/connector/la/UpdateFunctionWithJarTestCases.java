...
//TODO        OperationResult result = connectorModel.updateWithJar(FUNC_NAME, appJarFile);
...
//TODO        OperationResult result = connectorModel.updateWithJar(FUNC_NAME, lambdaFunctionJarFile);
//        assertTrue(result.success());
    ...
    public void failedUpdateWithInvalidFunctionName() throws Exception {
        File lambdaFunctionJarFile = getResourceFile(FUNC_JAR_FILE_NAME);
//TODO        OperationResult result = connectorModel.updateWithJar(INVALID_FUNC_NAME, lambdaFunctionJarFile);
//        assertFalse(result.success());
    }
